  ...
  <div class="tasks-cont">
    ...
    <div class="cards teachers">
      <CardBalanceTeachers v-show="isShow1"
        ...
        @clickOffReview="clickOffReview(cardTeacher.id)"
      />
    </div>
    ...
    <div @click="clickReviews" class="btn_section_1">
      <p class="heading-6">{{ text_btn }}</p>
      <img src="@/assets/img/edit-img/ArrowDown2.svg" alt="">
    </div>
  </div>
</template>
...
import img4 from '@/assets/img/mainpage-img/4cir.png'
  ...
  export default {
    ...
    data(){
      return {
        cardTeachers: [
          {id: 1, sub: "Иностранные языки", about: "Нужен репетитор по английскому", price: 15000, dateText: "27.05.2023 - 02.06.2023", who: "Александр Кайсаров", img: img1, review: "Оставить отзыв"},
          {id: 2, sub: "Математика и информатика", about: "Нужен репетитор по математике", price: 2000, dateText: "27.05.2023 - 02.06.2023", who: "Елюкина Виктория", img: img2, review: "Оставить отзыв"},
          {id: 3, sub: "Для взрослых", about: "Нужен репетитор для взрослых", price: 1000, dateText: "27.05.2023 - 02.06.2023", who: "Иван Петров", img: img3, review: "Оставить отзыв"},
          {id: 4, sub: "Физика и электротехника", about: "Нужен репетитор по физике", price: 5100, dateText: "27.05.2023 - 02.06.2023", who: "Мария Сидорова", img: img4, review: "Оставить отзыв"},
        ],
        cardPupils: [
          ...
          {id: 2, sub: "Математика и информатика", about: "Репетитор по математике", price: 5000, much:"Проведено 450 занятий", who: "Елюкина Виктория", img: img2, raiting_1: "4.5", raiting_2: "(40 отзывов)"},
          {id: 3, sub: "Для взрослых", about: "Репетитор для взрослых", price: 10000, much:"Проведено 450 занятий", who: "Иван Петров", img: img3, raiting_1: "4.5", raiting_2: "(40 отзывов)"},
          {id: 3, sub: "Физика и электротехника", about: "Репетитор по физике", price: 2500  , much:"Проведено 450 занятий", who: "Мария Сидорова", img: img4, raiting_1: "4.5", raiting_2: "(40 отзывов)"},
        ],
        cardConfirms: [
          {id: 1, sub: "Иностранные языки", about: "Нужен репетитор по английскому", price: 1500, dateText: "27.05.2023 - 02.06.2023", who: "Александр Кайсаров", img: img1},
          {id: 2, sub: "Математика и информатика", about: "Репетитор по математике", price: 10000, dateText: "27.05.2023 - 02.06.2023", who: "Елюкина Виктория", img: img2},
          {id: 3, sub: "Физика и электротехника", about: "Нужен репетитор по физике", price: 12500, dateText: "27.05.2023 - 02.06.2023", who: "Иван Петров", img: img3},
        ],
        fullItems1: [],
        fullItems2: [],
        text_btn: "Смотреть все",
        count: 0,
    ...
    methods:{
      clickReviews(){
        this.count ++
        if(this.count % 2 === 1){
          this.text_btn = "Скрыть"
          document.querySelector('.btn_section_1 img').style.transform = "rotate(180deg)"
          const newArr = this.cardPupils.slice(0, 2)
          this.cardPupils = this.cardPupils.concat(newArr)
          const newArr1 = this.cardTeachers.slice(0, 2)
          this.cardTeachers = this.cardTeachers.concat(newArr1)
        }
        else {
          this.text_btn = "Смотреть все отзывы"
          document.querySelector('.btn_section_1 img').style.transform = "unset"
          this.cardPupils = this.fullItems1
          this.cardTeachers = this.fullItems2
        } 
      },
      async clickOkNow(){
    ...
    created(){
      this.fullItems1 = [...this.cardPupils]
      this.fullItems2 = [...this.cardTeachers]
    }
  }
</script>
